'''
    @Author Jared Scott 
    This is an example of both large grid storage and manipulation 
'''      
...
count = 0
#for yList in grid:
#    for index in range(len(yList) - 3):
#        curProduct = yList[index] * yList[index+1] * yList[index+2] * yList[index+3]
        #print("Product: " + str(curProduct) + " " + str(yList[index]) + " " + str(yList[index+1]) + " " + str(yList[index+2]) + " " + str(yList[index+3]))
#        if curProduct > maxProduct:
#            maxProduct = curProduct

#Checking vertaical line multiplication 
...
#Checking horizontal line multiplication 
for xI in range(len(grid)-3):
    for yI in range(len(grid)-3):
        ...
        if curProduct > maxProduct:
            maxProduct = curProduct
print("-------------------------------------------------------------------------------------Max Product: " + str(maxProduct))
#Checking diagonal line multiplication 
