...
public class MinimizeRoman {
    /*
	 * This class will accept a text file containing roman numerals, it will then chew through each numeral and minimize it. 
     * In other words, it will take the numeral and if possible, re-write the same number in a minimized way.
	 * ARGUMENTS:
	 * 	    None: place your numerals within the file titled 'numerals.txt'
	 *
	 * OUTPUT:
	 *	    A printed count of the digits saved as well as the incremental adjustments made to each numeral. 
	 */
    ...
    public static void main(String[] args) throws FileNotFoundException {
        String attempt = "IIIX";
        File file = new File("./numerals.txt");
